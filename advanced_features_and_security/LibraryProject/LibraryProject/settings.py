...
SECRET_KEY = 'django-insecure-f**@i9jqbr530#g@$aqy69)9%^1)6dby4+6-2eqg$s#(y3r0$4'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'library_db',          # The database you created in MySQL
        'USER': 'root',                # Your MySQL username
        'PASSWORD': 'Ayomikun.098',   # Replace with your MySQL root password
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
